package com.codewars.kyu8.fundamentals.oppositesattract;
...
public class OppositesAttractTest {
    ...
    public void testRandoms() {
        ...
        for (int i = 0; i < NUM_RANDOM_TESTS; i++) {
            ...
            assertEquals(String.format("Testing %d and %d petals", flower1, flower2),
                    expected, OppositesAttract.isLove(flower1, flower2));
        }
    }
}
