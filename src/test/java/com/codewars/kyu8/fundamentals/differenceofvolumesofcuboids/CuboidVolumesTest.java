...
public class CuboidVolumesTest {
    ...
    public void sampleTestCases() {
        ...
        assertEquals("Testing for: " + Arrays.toString(a1) + Arrays.toString(b1), 14,  CuboidVolumes.findDifference(a1, b1));

        int[] a2 = new int[]{9, 7, 2}, b2 = new int[]{5, 2, 2};
        assertEquals("Testing for: " + Arrays.toString(a2) + Arrays.toString(b2), 106, CuboidVolumes.findDifference(a2, b2));

        int[] a3 = new int[]{11, 2, 5}, b3 = new int[]{1, 10, 8};
        assertEquals("Testing for: " + Arrays.toString(a3) + Arrays.toString(b3), 30,  CuboidVolumes.findDifference(a3, b3));

        int[] a4 = new int[]{4, 4, 7}, b4 = new int[]{3, 9, 3};
        assertEquals("Testing for: " + Arrays.toString(a4) + Arrays.toString(b4), 31,  CuboidVolumes.findDifference(a4, b4));

        int[] a5 = new int[]{15, 20, 25}, b5 = new int[]{10, 30, 25};
        assertEquals("Testing for: " + Arrays.toString(a5) + Arrays.toString(b5), 0,   CuboidVolumes.findDifference(a5, b5));
    }
    ...
    public void randomTestCases() {
        ...
        for (int i = 0; i < TEST_CASES; i++) {
            ...
            assertEquals("Testing for: " + Arrays.toString(a) + Arrays.toString(b),
                    result, CuboidVolumes.findDifference(a, b));
        }
    }
